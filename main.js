...
function testVar(){
  ...
  if(true){
    var a = 50;
    console.log(a); // will print 50
  }
  console.log(a); // will print 50
}

function testLet(){ // let doesn't have global scope
  let a = 30;
 
  if(true){
    let a = 50;
    console.log(a); // wil print 50
  }
  console.log(a); // will print 30 - reverts
}
...
function printFruit() {
  ...
  resultElement.textContent = "";
	...
	fruits.filter(fruits => fruits.startsWith("b"))
				.map(fruits => {
					let p = document.createElement("p");
